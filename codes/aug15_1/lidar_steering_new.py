...
def calculate_steering_error(scan_data, target_distance_mm=750, safety_distance_mm=150, clockwise=True):
    ...
    if clockwise:
        ...
        right_wall_angles_degrees = range(45,85)  # 45, 85
        left_wall_angles_degrees = range(-85, -45) # -90 to -30
    else:
        ...
        left_wall_angles_degrees = range(-90, -29)  # -110 to -30
...
def get_wall_parallel_error(scan_data, side):
