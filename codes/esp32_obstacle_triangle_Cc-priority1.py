...
TURN_TARGET_RIGHT_DEGREES = 73.0    # TUNED (was 80.0)
TURN_TARGET_LEFT_DEGREES = 73.0     # TUNED (was 80.0)
...
if __name__ == '__main__':
    ...
    #got a rubbing problem, side avoidance not working going to next
