...
CORNER_APPROACH_BRAKE_DISTANCE_MM = 500.0
CORNER_PIVOT_SPEED = 100
CORNER_PIVOT_SAFETY_TIMEOUT = 2.5
CORNER_BACKWARD_DURATION = 4.0
CORNER_BACKWARD_TOF_TARGET_MM = 150.0
...
def robot_control_loop():
    ...
    try:
        while not global_shutdown_event.is_set():
            ...
            # ====================================================
            if current_robot_state in [RobotState.CORNER_APPROACH_WALL, RobotState.CORNER_ACTIVE_PIVOT,RobotState.CORNER_POST_PIVOT_ALIGN, RobotState.CORNER_ALIGN_BACKWARD]:
